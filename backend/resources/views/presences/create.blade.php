...
@section('page-title', 'Ajouter une présence')
@section('page-subtitle', 'Enregistrement manuel d’une présence')
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                ...
                <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required>
                    ...
                    <option value="retard" {{ old('status') === 'retard' ? 'selected' : '' }}>Retard</option>
                    <option value="justifie" {{ old('status') === 'justifie' ? 'selected' : '' }}>Justifié</option>
                </select>
